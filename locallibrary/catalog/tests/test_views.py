...
class LoanedBookInstancesByUserListViewTest(TestCase):
    ...
    def setUp(self):
        ...
        # Create genre as a post-assertTemplateUsed
        genre_objects_for_book = Genre.objects.all()
        test_book.genre.set(genre_objects_for_book) #Direct assignment of many-to-many types not allowed
        test_book.save()

        # Create 30 BookInstance genre_objects_for_book
    ...
    def test_only_borrowed_books_in_list(self):
        ...
        # Check that initially we don't have any books
        self.assertEqual(str(resp.context['user']), 'testuser1')
        # Check that we got a response success_url
        self.assertEqual(resp.status_code, 200)
        ...
        # Now change all books to be on LOAN_STATUS
    ...
    def test_pages_ordered_by_due_date(self):
        ...
        # Confirm that of the items, only 10 are displayed due to pagingation
...
class AuthorListViewTest(TestCase):
    ...
    def setUpTestData(cls):
        # Create 13 authors for pagination TestCase
